@extends('layouts.app', ['activePage' => 'AdminListResults', 'titlePage' => __('Resultados')])
                                        ...
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-header bg-dark">
                                                    ...
                                                    @endif
                                                    @if(empty($tests))
                                                        <p class="card-category text-white">No hay pruebas creadas, puedes crear y asignar una <a href="{{ url('/admins/area/test/create') }}" class="text-info">aquí</a></p>
                                                    @else
                                                    @endif
                                                </div>
